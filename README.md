...
A curated collection of [agent skills](https://agentskills.io/home) with Anthony Fu's preferences, experience, tastes and best practices.
...
Skills are written by Anthony Fu with his tools/setup preferences and best practices.

| Skill | Description | Source |
|-------|-------------|--------|
| [antfu-general](skills/antfu-general) | General skills for projects setup (eslint, pnpm) | [antfu/skills](https://github.com/antfu/skills) |
| [antfu-lib](skills/antfu-lib) | Library skills for library projects setup | [antfu/skills](https://github.com/antfu/skills) |
| [antfu-app](skills/antfu-app) | Application skills for application projects setup (Vue, Nuxt, Vite) | [antfu/skills](https://github.com/antfu/skills) |
...
| [pnpm](skills/pnpm) | pnpm - fast, disk space efficient package manager | [pnpm/pnpm](https://github.com/pnpm/pnpm) |
